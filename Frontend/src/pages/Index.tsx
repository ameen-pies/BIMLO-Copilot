  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background" style={{ animation: "bgFadeIn 0.6s ease-out both" }}>
        ...
        <section className="relative pt-40 pb-24 px-6 min-h-screen flex items-center overflow-hidden">
          ...
          <div className="container mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <motion.h1
                className="font-heading text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground leading-tight max-w-4xl mb-6 flex flex-col items-center lg:items-start"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        {/* Features grid — kept for mobile & scroll section */}
        <section id="features" className="pt-0 pb-48 px-6">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: MessageSquare, title: "Intelligent Conversations", desc: "Chat naturally about telecom infrastructure with context-aware AI responses." },
                { icon: FileText,      title: "Document Analysis",         desc: "Upload PDFs, specs, and reports for instant AI-powered insights." },
                { icon: Network,       title: "Network Expertise",         desc: "Deep knowledge of fiber, 5G, and optical network deployments." },
                { icon: Zap,           title: "Instant Answers",           desc: "Get fast, accurate technical guidance for complex telecom decisions." },
              ].map((f, i) => (
                <motion.div
                  key={f.title}
